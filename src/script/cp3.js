...
function checkInputs() {
    ...
    if(primeiroNome === ''|| primeiroNome<6) {
        // mostrar erro
        // add classe
        setErrorFor(primeiroNome, 'nome com menos de 6 caractere')
    } else {
        // adicionar a classe de sucesso
        setSuccessFor(primeiroNome)
    }

    if(segundoNome === ''|| segundoNome<6) {
        // mostrar erro
        // add classe
        setErrorFor(segundoNome, 'nome com menos de 6 caractere')
    } else {
        // adicionar a classe de sucesso
        setSuccessFor(segundoNome)
    }
